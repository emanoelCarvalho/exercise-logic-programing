...
// Definindo os pesos, notas da prova e atividades
let p1 = 2;
let p2 = 3;
let a = 7;
let b = 8;
...
// Função para calcular a média ponderada e verificar se o estudante foi aprovado
...
// Definindo o número para o qual queremos encontrar os divisores pares
let numero = 12;
let divisores = 0;

// Usando um loop for para encontrar divisores pares
...
// Função para encontrar a quantidade de divisores pares de um número
